...
erase_compiled_function('TANKmodel_dgwages_static');
erase_compiled_function('TANKmodel_dgwages_dynamic');
M_.orig_eq_nbr = 14;
M_.eq_nbr = 14;
M_.ramsey_eq_nbr = 0;
...
options_.irf = 7;
options_.order = 1;
var_list_ = char('y_gap','pi','i','r_real','nu','c_R','c_K','n_R','n_K','w_real');
