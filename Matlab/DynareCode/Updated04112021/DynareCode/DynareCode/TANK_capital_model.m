...
M_.endo_names_long = char(M_.endo_names_long, 'Total consumption');
...
options_.irf = 7;
options_.order = 1;
var_list_ = char('y_gap','y','y_nat','pi','i','r_real','k','invest','q','nu','c_R','c_K','n_R','n_K','w_real');
...
if exist('dataset_info', 'var') == 1
  save('TANK_capital_model_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('TANK_capital_model_results.mat', 'oo_recursive_', '-append');
end
