...
M_.mapping.y_gap.eqidx = [1 6 8 11 ];
M_.mapping.y_nat.eqidx = [10 ];
M_.mapping.y.eqidx = [11 14 ];
M_.mapping.r_real.eqidx = [5 9 ];
M_.mapping.i.eqidx = [4 5 8 9 ];
M_.mapping.n.eqidx = [7 14 ];
M_.mapping.n_R.eqidx = [2 7 ];
M_.mapping.n_K.eqidx = [3 5 7 ];
M_.mapping.c_R.eqidx = [2 4 6 ];
M_.mapping.c_K.eqidx = [3 5 6 ];
M_.mapping.w_real.eqidx = [2 3 5 ];
...
if exist('dataset_info', 'var') == 1
  save('TANKmodel_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('TANKmodel_results.mat', 'oo_recursive_', '-append');
end
