...
plot_xlabel = [string('Proportion of Non-Ricardian Households'),string('Non-Ricardian Household Debt Level')];
...
legend('boxoff');
xlabel('Time (years)');
title('Non-Ricardian Consumption Path');
ylabel('Consumption');
...
fprintf(error_table, '$\\psi_c$ & Total Consumption & Ricardian Consumption & Non-Ricardian Consumption \n');
