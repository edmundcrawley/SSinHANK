...
residual(1)= lhs-rhs;
lhs =y(17);
rhs =params(4)*(params(13)*y(14)+params(12)*y(15))/(params(13)+params(12))+params(5)*y(11);
residual(2)= lhs-rhs;
lhs =y(12);
rhs =y(13);
residual(3)= lhs-rhs;
...
residual(7)= lhs-rhs;
lhs =y(16);
rhs =(params(13)*y(14)+params(12)*y(15))/(params(13)+params(12));
residual(8)= lhs-rhs;
lhs =y(21)*params(16);
...
residual(13)= lhs-rhs;
lhs =y(7);
rhs =psi_n_ya__*(y(19)+params(1)*y(4));
residual(14)= lhs-rhs;
lhs =y(6);
rhs =y(8)-y(7);
residual(15)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(1,6)=(-kappa__);
  g1(2,11)=(-params(5));
  g1(2,14)=(-(params(4)*params(13)/(params(13)+params(12))));
  g1(2,15)=(-(params(4)*params(12)/(params(13)+params(12))));
  g1(2,17)=1;
  g1(3,12)=1;
  g1(3,13)=(-1);
  g1(4,23)=(-(1/params(4)));
  ...
  g1(7,12)=(-params(15));
  g1(7,13)=(-params(14));
  g1(8,14)=(-(params(13)/(params(13)+params(12))));
  g1(8,15)=(-(params(12)/(params(13)+params(12))));
  g1(8,16)=1;
  g1(9,4)=1-params(16);
  g1(9,20)=(-1);
  g1(9,21)=params(16);
