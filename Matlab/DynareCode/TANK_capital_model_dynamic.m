...
residual(8)= lhs-rhs;
lhs =y(9);
rhs =(1-params(2)*(1-params(16)))*(y(24)+y(22)-y(19));
residual(9)= lhs-rhs;
lhs =y(10);
...
if nargout >= 2,
  ...
  g1(8,20)=params(16);
  g1(9,9)=1;
  g1(9,22)=(-(1-params(2)*(1-params(16))));
  g1(9,24)=(-(1-params(2)*(1-params(16))));
  g1(9,19)=1-params(2)*(1-params(16));
  g1(10,5)=(-params(6));
  g1(10,6)=(-params(7));
  g1(10,10)=1;
  g1(10,17)=(-1);
