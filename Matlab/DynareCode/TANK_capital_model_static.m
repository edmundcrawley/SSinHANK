...
residual(1)= lhs-rhs;
lhs =y(13);
rhs =params(4)*(params(13)*y(10)+params(12)*y(11))/(params(13)+params(12))+params(5)*y(7);
residual(2)= lhs-rhs;
lhs =y(8);
rhs =y(9);
residual(3)= lhs-rhs;
...
residual(7)= lhs-rhs;
lhs =y(12);
rhs =(params(13)*y(10)+params(12)*y(11))/(params(13)+params(12));
residual(8)= lhs-rhs;
lhs =y(17)*params(16);
...
residual(13)= lhs-rhs;
lhs =y(3);
rhs =psi_n_ya__*(y(15)+params(1)*y(16));
residual(14)= lhs-rhs;
lhs =y(2);
rhs =y(4)-y(3);
residual(15)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(1,2)=(-kappa__);
  g1(2,7)=(-params(5));
  g1(2,10)=(-(params(4)*params(13)/(params(13)+params(12))));
  g1(2,11)=(-(params(4)*params(12)/(params(13)+params(12))));
  g1(2,13)=1;
  g1(3,8)=1;
  g1(3,9)=(-1);
  g1(4,1)=(-(1/params(4)));
  ...
  g1(7,8)=(-params(15));
  g1(7,9)=(-params(14));
  g1(8,10)=(-(params(13)/(params(13)+params(12))));
  g1(8,11)=(-(params(12)/(params(13)+params(12))));
  g1(8,12)=1;
