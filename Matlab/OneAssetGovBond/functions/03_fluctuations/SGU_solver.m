function [hx,gx,F1,F2,F3,F4,par] = SGU_solver(F,oc,mpar,par)
...
% Absolute deviations
par.scaleval1 = 1e-4; %vector of numerical differentiation step sizes
par.scaleval2 = 1e-4; %vector of numerical differentiation step sizes
...
parfor bl=1:blocks
    ...
    if sum(range==mpar.numstates-1)==1
