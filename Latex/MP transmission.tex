...
\usepackage{mwe}
\usepackage{natbib}\usepackage{har2nat}
...
\begin{table}[!htbp]
\caption{\normalsize{Calibrated Parameters}} % title of Table
\centering % used for centering table
\begin{threeparttable}

\begin{adjustbox}{width=13.5cm, totalheight=9cm}
\begin{tabular}{l l r c} % centered columns (4 columns)
\toprule
...
% \multicolumn{2}{l}{Intermediate Goods}\\
% $\alpha$ & Share of labor & 0.70 \\
% $\delta$ & Depreciation rate & 1.35\% \\
\addlinespace[4pt]
...
% $\tau_t$ & Labor tax & 5\% \\
% $\frac{G}{Y}$ & Government spending/output &  4.1\% \\
...
%\multicolumn{2}{l}{Shocks}\\
%$\rho_i$, $\sigma_i$ \footnotesize{(i=MP,Pref,TFP)} & \footnotesize{Persistence, standard deviation} & 0.8, 0.01\\
%\addlinespace[8pt]
...
\end{adjustbox}
% \begin{tablenotes}
% \item{\footnotesize{1) $\tau = 0$}}
% \item{\footnotesize{2) Average borrowing wedge (1998-2016, FRB commercial \& industrial loan rate) }}
% \item{\footnotesize{3) Average bank capital to asset ratio (1998-2015, World Bank)}} 
% \item{\footnotesize{4) Average capital to GDP ratio (1983-2015, NIPA) }}
% \item{\footnotesize{5) Average ratio of net liquid to net illiquid assets (1983-2013, SCF)}}
% \end{tablenotes}
\end{threeparttable}
...
\begin{figure} 
	\begin{centering}
        \begin{subfigure}[b]{0.475\textwidth}
            \centering
		\includegraphics[scale=0.45]{../Matlab/Figures/IRF_C.pdf}
%            \caption[Network2]%
%            {{\small Network 1}}    
            \label{fig:IRF_C}
        \end{subfigure}	
        ...
        \begin{subfigure}[b]{0.475\textwidth}  
            \centering 
		 \includegraphics[scale=0.45]{../Matlab/Figures/IRF_PI.pdf}
%            \caption[]%
%            {{\small Network 2}}    
            \label{fig:IRF_PI}
        \end{subfigure}
...
%        \label{fig:IRFs following 1% rises of nominal monetary policy}                
	\end{centering}
\end{figure}
...
\begin{floatrow}
\ffigbox{%
   \includegraphics[height=5cm, width=5.5cm]{../Matlab/Figures/IRF_C_by_sufficient.png}
}
{%
  \caption{}%
}
\capbtabbox{%
    \begin{tabular}[b]{l r}
\toprule     
Aggregate Income & 18.9\% 
\\ Earnings Heterogeneity & 39.5\% 
\\ Interest Rate Exposure & 6.5\% 
\\ Fisher & 8.3\% 
\\ Intertemporal Substitution & 17.5\% 
\\ Error & 9.3\% \\
\bottomrule
    \end{tabular}
}{%
