...
We find the income channels (both aggregate and heterogeneous) act as a multiplier for both the intertemporal substitution and the interest rate exposure channels. As we decrease the elasticity of intertemporal substitution, the intertemporal substitution channels diminishes along with the income multipliers of it. The interest rate exposure channel, on the other hand, remains the same size. This suggests it may be possible to creast a monetary policy model in which intertemporal substitution plays no role at all, but which nonetheless fits the macrodata. This is something we plan to tackle in future work.
